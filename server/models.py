...
class Employee(db.Model):
    ...
    # The relationship() method is passed an additional parameter secondary,
    # which indicates the relationship is implemented through the employee_meetings table.
